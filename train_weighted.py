...
from data import fusion_weighted_dataset
...
def train(Dataset, Network, args):
    exp_name = f"scwssod_{args.mask_dir}_weighted"
    ...
    cfg = Dataset.Config(
        ...
        intersection_weight=args.intersection_weight,
...
if __name__ == '__main__':
    args = parse_args()
    train(fusion_weighted_dataset, SCWSSOD, args)
